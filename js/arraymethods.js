// array : String, number, object, functionn, campuran

let nilai = [
    { nama: "budi", ipa: 90, bahasa: 70, matematika: 70 },
    { nama: "johnatan", ipa: 80, bahasa: 90, matematika: 60 },
    { nama: "ardi", ipa: 75, bahasa: 70, matematika: 90 },
    { nama: "veve", ipa: 90, bahasa: 80, matematika: 90 },
]

let nama = ["budi", "johnatan", "ardi", "veve"];
// nama.push("ani", "rama");
